...
//Booking Methods
export function insertBooking(date, locationID, locationType, title, description, startTime, endTime, bookingColor, noiseLevel) {
    ...
    return myFetch(api_root + "/app/insertBooking", {
        email, password, firstName, lastName, date, locationID, locationType, title, description, startTime, endTime, bookingColor, noiseLevel
    });
}
