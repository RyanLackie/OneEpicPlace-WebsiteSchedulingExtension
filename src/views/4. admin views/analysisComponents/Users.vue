<template>
    <div class='container'>
        ...
        <div v-for="(user, index) in $parent.selectedUsers" :key="'user:'+user.id" 
        class="row align-items-center" :style='"min-height: 100px; text-align: center; "+$parent.styleRow(index)'>
            ...
            <div class="col">
                <div class="text-container">
                    <div class="col-text">
                        {{Math.round(100 * user.hours) / 100}}
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="bar-graph">
                    <div class="bar-graph--bar" v-for="(bar, index) in user.activity" :key="'bar:'+index"
                    :style="$parent.styleBar(bar, user.activity)"></div>
                    <div class="bar-graph--time" v-for="(bar, index) in user.activity" :key="'time:'+index">
            ...
            <div class="col">
                <select style='width: 100%;'>
                    <option v-for="(location, index) in user.locations" :key="'location:'+index">
            ...
            <div class="col">
                <select style='width: 100%;'>
                    <option v-for="(resource, index) in user.resources" :key="'resource:'+index">
